            ...
            <div className="col-sm-12">
              <div className="card">
                <div className="card-header d-flex align-items-center justify-content-between">
                  ...
                  <a href="add-patient.html" className="btn btn-primary ms-auto">Add Patient</a>
                </div>
                    ...
                    <table id="basicExample" className="table truncate m-0 align-middle">
                      ...
                      <tbody>
                        <tr>
                          <td>#89990</td>
                          <td>
                            <img src="assets/images/patient.png" className="img-shadow img-2x rounded-5 me-1" alt="Medical Admin Template" />
                            Allan Stuart
                          </td>
                          <td><span className="badge bg-info-subtle text-info">Male</span></td>
                          <td>67</td>
                          <td>O+</td>
                          <td>
                            Diabetes
                          ...
                          <td>
                            <div className="d-inline-flex gap-1">
                              ...
                              <a href="patient-dashboard.html" className="btn btn-outline-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View Dashboard">
                        ...
                        <tr>
                          <td>#89992</td>
                          <td>
                            <img src="assets/images/patient1.png" className="img-shadow img-2x rounded-5 me-1" alt="Medical Admin Template" />
                            Katie Robinson
                          </td>
                          <td><span className="badge bg-warning-subtle text-warning">Female</span></td>
                          <td>33</td>
                          <td>B+</td>
                          <td>
                            Pediatric
                        ...
                        <tr>
                          <td>#89995</td>
                          <td>
                            <img src="assets/images/patient2.png" className="img-shadow img-2x rounded-5 me-1" alt="Medical Admin Template" />
                            Pam Higgins
                          </td>
                          <td><span className="badge bg-info-subtle text-info">Male</span></td>
                          <td>28</td>
                        ...
                        <tr>
                          <td>#89345</td>
                          <td>
                            <img src="assets/images/patient3.png" className="img-shadow img-2x rounded-5 me-1" alt="Medical Admin Template" />
                            Ashley Clay
                          </td>
                          <td><span className="badge bg-info-subtle text-info">Male</span></td>
                          <td>77</td>
                        ...
                        <tr>
                          <td>#87690</td>
                          <td>
                            <img src="assets/images/patient4.png" className="img-shadow img-2x rounded-5 me-1" alt="Medical Admin Template" />
                            Keith Coleman
                          </td>
                          <td><span className="badge bg-warning-subtle text-warning">Female</span></td>
                          <td>49</td>
                        ...
                        <tr>
                          <td>#82894</td>
                          <td>
                            <img src="assets/images/patient5.png" className="img-shadow img-2x rounded-5 me-1" alt="Medical Admin Template" />
                            Nick Morrow
                          </td>
                          <td><span className="badge bg-info-subtle text-info">Male</span></td>
                          <td>69</td>
