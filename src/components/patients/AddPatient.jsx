                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row gx-3">
                                        ...
                                        <div className="col-xxl-3 col-lg-4 col-sm-6">
                                            <div className="mb-3">
                                                <label className="form-label" htmlFor="a8">Occupation</label>
                                        ...
                                        <div className="col-xxl-3 col-lg-4 col-sm-6">
                                            <div className="mb-3">
                                                <label className="form-label" htmlFor="a9">Blood Group <span className="text-danger">*</span></label>
                                        ...
                                        <div className="col-xxl-3 col-lg-4 col-sm-6">
                                            <div className="mb-3">
                                                <label className="form-label" htmlFor="a10">Blood Presure</label>
                                                <input type="text" className="form-control" id="a10" placeholder="Enter Blood Presure" />
                                            </div>
                                        </div>
                                        <div className="col-xxl-3 col-lg-4 col-sm-6">
                                            <div className="mb-3">
                                                <label className="form-label" htmlFor="a11">Sugar</label>
                                                <input type="text" className="form-control" id="a11" placeholder="Enter Sugar Levels" />
                                            </div>
                                        </div>
                                        <div className="col-xxl-3 col-lg-4 col-sm-6">
                                            <div className="mb-3">
                                                <label className="form-label" htmlFor="a12">Address</label>
                                                <input type="text" className="form-control" id="a12" placeholder="Enter Address" />
                                            </div>
                                        </div>
                                        <div className="col-xxl-3 col-lg-4 col-sm-6">
                                            <div className="mb-3">
                                                <label className="form-label" htmlFor="a13">City</label>
                                                <input type="text" className="form-control" id="a13" placeholder="Enter City" />
                                            </div>
                                        </div>
                                        <div className="col-xxl-3 col-lg-4 col-sm-6">
                                            <div className="mb-3">
                                                <label className="form-label" htmlFor="a14">State</label>
                                        ...
                                        <div className="col-sm-12">
                                            <div className="d-flex gap-2 justify-content-end">
                                                <a href="patients-list.html" type="button" className="btn btn-outline-secondary">
                                                    Cancel
                                                </a>
                                                <a href="patients-list.html" type="button" className="btn btn-primary">
