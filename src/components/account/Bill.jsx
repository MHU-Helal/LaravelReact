...
const baseUrl = "http://localhost/ReviveMe_ERP/ReviveMe2.1/api/";

const CreateBill = () => {
    // const baseUrl = "http://localhost/00ERP/ReviveMe2.1/api/";
    ...
    <p className="mb-1"><input className="form-control" type="text" placeholder="Name" name="name" id="name" /></p>
    <p className="mb-1"><input className="form-control" type="text" onChange={fetchPatient} placeholder="Phone" name="phone" id="phone" /></p>
    <p className="mb-1"><input className="form-control" type="text" placeholder="Email" name="email" id="email" /></p>
                        </div>
                        <div className="col-md-4">
